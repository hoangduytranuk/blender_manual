...
export BLENDER_EXE=/Applications/Blender.app/Contents/MacOS
...
export BLENDER_SRC=~/blender-git/blender
export LOCAL_BIN=$HOME/Library
export LOCAL_PYTHON=$LOCAL_BIN/Python
export LOCAL_PYTHON_3=/usr/local/lib/python3.7/site-packages
export CMAKE=/Applications/CMake.app/Contents/bin
export PATH=$BLENDER_EXE:$CMAKE:$GETTEXT/bin:$CMAKE_BIN:$HOME_BIN:$OLD_HOME_BIN:$LOCAL_BIN:$LOCAL_PYTHON_3/bin:$PATH
