...
class FindUntranslated:
    ...
    def setVars(self, input_file=None):
        self.input_file=(FindUntranslated.from_vipo_path if (input_file == None) else input_file)
    ...
    def run(self):
        ...
        for index, po_entry in enumerate(po_cat):
            ...
            is_ignore = (is_ignore_word or is_number or is_single_char or is_resolution or is_hz or is_untranslated)
            if (is_ignore):
                continue
