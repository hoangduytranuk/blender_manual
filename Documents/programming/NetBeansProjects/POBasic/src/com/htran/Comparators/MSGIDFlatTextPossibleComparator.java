 ...
 * @author htran
 */
public class MSGIDFlatTextPossibleComparator implements Comparator {
    public static MSGIDFlatTextPossibleComparator this_instance = null;

    public static MSGIDFlatTextPossibleComparator getInstance() {
        if (this_instance == null) {
            this_instance = new MSGIDFlatTextPossibleComparator();
        }
    ...
    public int compare(Object o1, Object o2) {
        ...
        try {
            ...
            if (is_comparable) {
                ...
                compare_value = (is_possible) ? 0 : str_1.compareTo(str_2);
            }//end if
        } catch (Exception ex) {
            ex.printStackTrace();
