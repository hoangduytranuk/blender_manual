...
in the current blend-file. You still need to save the file if you want to write them on drive.
...
You still need to save the file if you want to clear them from drive.
...
in one or more blend-file on your drive. You should not use that operator on the file currently opened in Blender.
