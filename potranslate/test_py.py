...
# which is only effective in *Envelope* visualization,
# even though it is always available...",
# ''',
                # "Scale Thickness",
                # "Scale Transforms",
                ...
                # "See examples below.",
                # "See the *Vertex Mapping* option.",
                # "See the Fig.",
                # "Selecting only the Mesh and bones is not strictly necessary. Selecting and export only selected will give smaller dae.",
                # "Self-Collision",
                # "Shared Tex Space",
                # "Shortcut sculpting only.",
                # "Shortcut: :kbd:`Ctrl-L` ...",
                # "Show Curve Extremes` are enabled",
