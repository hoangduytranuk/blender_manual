import re
from common import Common as cm, MatcherRecord, dd, pp
...
class RefItem:
    ...
    def removeBlankFromText(self):
        ...
        # pattern_txt = r'\%s|\%s' % (cm.FILLER_CHAR, ' ')
        # # part_dict = cm.findInvert(cm.FILLER_CHAR_INVERT, self.text)
        part_dict = cm.findInvert(cm.FILLER_CHAR_OR_SPACE, self.text)
